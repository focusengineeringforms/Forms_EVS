    ...
    <div className="w-full">
      {section.title !== formTitle && section.title !== "Section 1" && (
        <div className="relative mb-2 w-full flex justify-center items-start">
          <div className="text-center flex flex-col items-center w-full px-10 md:px-2">
            <h2
          ...
          {rightWidget && (
            <div className={`absolute -top-6 md:top-0 ${language === 'ar' || language === 'both' ? 'left-0' : 'right-0'} z-50`}>
              {rightWidget}
            </div>
          )}
        </div>
