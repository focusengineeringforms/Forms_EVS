    ...
    <div className="space-y-4">
      {roles.map((role) => (
        ...
        >
              ...
              {role.isSystem ? (
                ...
                <>
                  <button
                    ...
                    className="p-2 text-primary-600 hover:text-primary-800 rounded-lg hover:bg-primary-50 transition-colors"
                    title="Edit Role"
                  >
          ...
          <div className="space-y-4">
            <div>
              <h6 className="text-sm font-medium text-primary-600 mb-2">
                Permissions
              </h6>
              ...
              <div>
                ...
                <div className="grid gap-2">
                  {role.formPermissions.map((fp) => (
                    <div
                      key={fp.formId}
                      className="bg-gray-50 rounded-lg p-3 border border-neutral-200"
                    >
