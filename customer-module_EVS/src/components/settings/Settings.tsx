...
import { Save, X, UserCircle, Users, Settings as SettingsIcon, FileText } from 'lucide-react';
import { useTheme } from '../../context/ThemeContext';
import SettingsGeneral from './sections/SettingsGeneral';
import SettingsProfile from './sections/SettingsProfile';
import SettingsForms from './sections/SettingsForms';
...
type SettingsTab = 'general' | 'profile' | 'team' | 'forms' | 'management';
...
export default function Settings({ onClose }: SettingsProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={(e) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl m-4 flex flex-col max-h-[90vh]">
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-6">
              ...
              {activeTab === 'management' && <Management onClose={onClose} />}
            </div>
          </div>
        </div>
      </div>
