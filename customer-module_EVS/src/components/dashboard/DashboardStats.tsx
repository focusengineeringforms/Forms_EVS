        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className={`rounded-xl p-3 ${stat.bg} cursor-help group relative`} title={stat.description}>
              ...
              />
              <div className="absolute hidden group-hover:block bg-gray-900 text-white text-xs rounded py-1 px-2 bottom-full right-0 mb-2 whitespace-nowrap z-50 pointer-events-none">
                {stat.description}
              </div>
            </div>
          </div>
