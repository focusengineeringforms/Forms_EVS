...
export function useForms() {
  return useApi(apiClient.getForms.bind(apiClient), true, 5000); // Poll every 5 seconds
}

export function useResponses() {
  return useApi(apiClient.getResponses.bind(apiClient), true, 5000); // Poll every 5 seconds
}
