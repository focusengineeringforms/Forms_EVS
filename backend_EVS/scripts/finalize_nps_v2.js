...
async function main() {
  try {
    ...
    // 1. Correct Logo: High-res white background version (media__1775025068415.png)
    const logoLocalPath = 'C:\\Users\\Welcome\\.gemini\\antigravity\\brain\\ebef2388-89b8-461a-b19c-ac630866994b\\media__1775025068415.png';
    ...
    // 2nd question: "radio" instead of "rating" to avoid stars
    const correctSections = [
      {
        ...
        questions: [
          ...
          {
            id: "q_2",
            type: "emoji-star-feedback", // Emojis are often preferred over plain numbers, but user said "not as star". 
            // Better switch to plain scale for 2nd question too
            text: "SPECIFICALLY, HOW SATISFIED ARE YOU WITH YOUR RECENT SERVICE EXPERIENCE?",
            required: true,
            min: 1,
            max: 5,
            options: ["VERY UNSATISFIED", "VERY SATISFIED"],
            type: "scale" // Changed to scale (1-5) to avoid stars
          },
          {
            id: "q_3",
            type: "paragraph",
    ...
    console.log(`SUCCESS! NPS form (${targetId}) final layout and white logo applied.`);
