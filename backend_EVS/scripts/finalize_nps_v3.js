...
async function main() {
  try {
    ...
    // 2nd question: NOT as star, but as scale (1-5) to avoid star layout
    const correctSections = [
      {
        ...
        questions: [
          ...
          {
            id: "q_2",
            type: "scale", // Changed to scale (1-5) to avoid star layout
    ...
    console.log(`SUCCESS! NPS form (${targetId}) updated: 2nd question as Scale (numbers), white logo applied.`);
