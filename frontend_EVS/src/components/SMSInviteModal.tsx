                        ...
                        <div className="space-y-6">
                                    ...
                                    {previewData.preview.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="col-span-3">
                                                <span
                                                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${item.status === "valid"
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Choose how the SMS should appear</p>
                                </div>
                                <div className="flex bg-white border border-gray-200 rounded-md p-1">
                                    {(['en', 'ar', 'both'] as const).map((lang) => (
                                        ...
                                        >
                                            {lang === 'both' ? 'Both' : lang === 'en' ? 'English' : 'Arabic'}
                                        </button>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                ...
                                <button
                                    ...
                                    className="btn-primary px-6 py-2 font-medium flex items-center gap-2 bg-purple-600 hover:bg-purple-700"
                                >
                                    {isSending ? (
                                        <>
                                        ...
                                        <>
                                            ...
                                            Send {selectedPhones.size} SMS Invites
                                        </>
                                    )}
                                </button>
                            </div>
                    ...
                    {step === "complete" && sendResults && (
                        <div className="text-center py-8">
                                        ...
                                        <div className="bg-red-50 border border-red-200 rounded-lg p-3 max-h-32 overflow-y-auto">
                                            {sendResults.failures.map(
                                                (failure: any, index: number) => (
                                                    ...
                                                    >
                                                        {failure.phone || failure.email}: {failure.reason}
                                                    </div>
                                                )
                                            )}
                                        </div>
                            ...
                            <div className="flex justify-center gap-3">
                                <button
                                    onClick={handleClose}
                                    className="btn-primary px-6 py-2 font-medium bg-purple-600 hover:bg-purple-700"
                                >
                                    Done
                                </button>
                                <button
